...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "train": {
        ...
        "val_fraction": 0.1,
        "num_workers": 8,
        "mae": {"epochs": 300, "batch_size": 1024, "lr": 3e-4, "weight_decay": 0.05, "early_stop_patience": 30, "early_stop_min_delta": 0.0},
        "tfc": {"epochs": 200, "batch_size": 768, "lr": 1e-4, "weight_decay": 0.05, "early_stop_patience": 30, "early_stop_min_delta": 0.0},
        "finetune": {"epochs": 150, "batch_size": 512, "lr": 1e-3, "weight_decay": 0.05, "label_smoothing": 0.1, "early_stop_patience": 30, "early_stop_min_delta": 0.0},
    },
    "head": {
        "name": "mlp",
        "dropout": 0.3,
